...
public class ContactMen implements Parcelable {
	...
	protected ContactMen(Parcel in) {
		...
		phone_adress = in.readString();
		phone_operator = in.readString();
		isFavorite = in.readByte() != 0;
	}

	public static final Creator<ContactMen> CREATOR = new Creator<ContactMen>() {
		@Override
		public ContactMen createFromParcel(Parcel in) {
			return new ContactMen(in);
		}

		@Override
		public ContactMen[] newArray(int size) {
			return new ContactMen[size];
		}
	};
	...
	public void writeToParcel(Parcel parcel, int i) {
		...
		parcel.writeLong(img_id);
		parcel.writeString(name);
		parcel.writeString(number);
		parcel.writeString(address);
		parcel.writeString(email);
		parcel.writeString(birthday);
		parcel.writeString(phone_adress);
		parcel.writeString(phone_operator);
